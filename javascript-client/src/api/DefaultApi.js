...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the patientOptions operation.
     * @callback module:api/DefaultApi~patientOptionsCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
    ...
    /**
     * @param {module:api/DefaultApi~patientOptionsCallback} callback The callback function, accepting three arguments: error, data, response
     */
    this.patientOptions = function(callback) {
      var postBody = null;
    ...
    /**
     * Callback function to receive the result of the updatePatientRecord operation.
     * @callback module:api/DefaultApi~updatePatientRecordCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Array.<module:model/Object>} patient Patient object to update
     * @param {module:api/DefaultApi~updatePatientRecordCallback} callback The callback function, accepting three arguments: error, data, response
     */
    this.updatePatientRecord = function(patient, callback) {
      var postBody = patient;

      // verify the required parameter 'patient' is set
      if (patient === undefined || patient === null) {
        throw new Error("Missing the required parameter 'patient' when calling updatePatientRecord");
      }
