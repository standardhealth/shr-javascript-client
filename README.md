...
## Update NPM Package
The `javascript-client` library is published on NPM as a package called `shr_rest_client`. This allows it to be imported on other projects and used to make REST API calls.
